...
/**
 * @brief Configure AI permissions in native backend.
 */
CoreResult core_ai_set_permissions(
    CoreContext* core,
    const CoreAiPermissions* permissions
);

/**
 * @brief Retrieve AI permissions from native backend.
 */
CoreResult core_ai_get_permissions(
    CoreContext* core,
    CoreAiPermissions* outPermissions
);

/**
 * @brief Record a state transition as AI learning input.
 */
CoreResult core_ai_record_pattern(
    CoreContext* core,
    const char* uuid,
...
/**
 * @brief Observe an app-open event for behavior inference.
 */
CoreResult core_ai_observe_app_open(
    CoreContext* core,
    uint64_t timestampMs
);

/**
 * @brief Observe profile application for behavior inference.
 */
CoreResult core_ai_observe_profile_apply(
    CoreContext* core,
...
/**
 * @brief Ask the native AI backend to process a chat message.
 */
CoreResult core_ai_process_chat(
    CoreContext* core,
    const char* input,
    char* outResponse,
...
/**
 * @brief Return latest behavior annotations generated by backend AI.
 */
CoreResult core_ai_get_annotations(
    CoreContext* core,
    char* outAnnotations,
...
/**
 * @brief Execute assistant command fully in backend and return response text.
 */
